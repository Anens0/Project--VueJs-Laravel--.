...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/app2.css">
    ...
    <link rel="stylesheet" href="../resources/css/flash.css">
    <title>Hotel</title>
</head>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./image/_hotel1.jpg">
            </div>
            <!--
            <div class="carousel-item">
                <img class="carousel-image" src="./image/_hotel2.jpg">
            </div>
             -->
            <div class="carousel-item">
                <img class="carousel-image" src="./image/_hotel3.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/_hotel4.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/_hotel5.jpg">
            </div>
        </div>
    </section>
            ...
            <div id="Log_in">
                ...
                if (isset($_POST['Emp_login_submit'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        $Email = "";
                        $Password = "";
                        header("Location: admin/admin.blade.php");
                    } else {
                        echo "<script>swal({
                                title: 'Something went wrong',
                                icon: 'error',
...
<script src="../resources/views/js/app2.js"></script>
