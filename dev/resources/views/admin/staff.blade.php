...
<head>
    ...
    <link rel="stylesheet" href="../resources/views/css/room.css">
    <style>
        .roombox {
...
<body>
    ...
    <!-- here room add because room.blade.php and staff.blade.php both css is similar -->
    <div class="room">
        <?php
        $sql = "SELECT name,work,id FROM staff";
        ...
        while ($row = mysqli_fetch_array($re)) {
            echo "<div class='roombox'>
						<div class='text-center no-boder'>
                            ...
                            <a href='staffdelete.blade.php?id=" . $row['id'] . "'><button class='btn btn-danger'>Delete</button></a>
						</div>
                    </div>";
        }
        ?>
