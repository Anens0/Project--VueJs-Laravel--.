...
<head>
	<meta charset="utf-8">
	<title>Invoice</title>
	<link rel="stylesheet" href="../resources/views/js/style.css">
	<link rel="license" href="https://www.opensource.org/licenses/mit-license/">
	<script src="../resources/views/js/active.js"></script>
	<style>
		/* reset */
...
<body>
	...
	$sql = "SELECT id,idroom,Name,roomtype,Bed,noofroom,cin,cout,meal,roomtotal,mealtotal,bedtotal,finaltotal,noofdays FROM payment WHERE id = '$id' ";
